...
(footprint "xiao_smd"
 ...
 (layer "B.SilkS")
  ...
  (pad "1" smd oval (at -7.62 -7.62 ${
    180 + p.rot
  }) (size 2.75 1.8) (drill (offset 0.475 0)) (layers "F.Cu" "F.Paste" "F.Mask")
  ${p.D0.str})
  (pad "2" smd oval (at -7.62 -5.08 ${
    180 + p.rot
  }) (size 2.75 1.8) (drill (offset 0.475 0)) (layers "F.Cu" "F.Paste" "F.Mask")
  ${p.D1.str})
  (pad "3" smd oval (at -7.62 -2.54 ${
    180 + p.rot
  }) (size 2.75 1.8) (drill (offset 0.475 0)) (layers "F.Cu" "F.Paste" "F.Mask")
  ${p.D2.str})
  (pad "4" smd oval (at -7.62 0 ${
    180 + p.rot
  }) (size 2.75 1.8) (drill (offset 0.475 0)) (layers "F.Cu" "F.Paste" "F.Mask")
  ${p.D3.str})
  (pad "5" smd oval (at -7.62 2.54 ${
    180 + p.rot
  }) (size 2.75 1.8) (drill (offset 0.475 0)) (layers "F.Cu" "F.Paste" "F.Mask")
  ${p.D4.str})
  (pad "6" smd oval (at -7.62 5.08 ${
    180 + p.rot
  }) (size 2.75 1.8) (drill (offset 0.475 0)) (layers "F.Cu" "F.Paste" "F.Mask")
  ${p.D5.str})
  (pad "7" smd oval (at -7.62 7.62 ${
    180 + p.rot
  }) (size 2.75 1.8) (drill (offset 0.475 0)) (layers "F.Cu" "F.Paste" "F.Mask")
  ${p.D6.str})
  ...
  (pad "15" thru_hole circle (at -1.27 -8.572 ${
    90 + p.rot
  }) (size 1.397 1.397) (drill 1.016) (layers "*.Cu" "*.Mask")
  ${p.CLK.str})
  ...
  ${p.BAT.str})
  (pad "20" thru_hole circle (at 3.81 9.208 ${
    180 + p.rot
  }) (size 1.397 1.397) (drill 1.016) (layers "*.Cu" "*.Mask")
  ${p.NFC1.str})
  (pad "21" thru_hole circle (at 5.715 9.208 ${
    180 + p.rot
  }) (size 1.397 1.397) (drill 1.016) (layers "*.Cu" "*.Mask")
  ${p.NFC2.str})
)
