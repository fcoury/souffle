...
module.exports = {
  ...
  (footprint "ceoloide:display_nice_view"
    ...
    (model ${p.niceview_3dmodel_filename}
      (offset (xyz ${p.niceview_3dmodel_xyz_offset[0]} ${
      p.niceview_3dmodel_xyz_offset[1]
    } ${p.niceview_3dmodel_xyz_offset[2]}))
      (scale (xyz ${p.niceview_3dmodel_xyz_scale[0]} ${
      p.niceview_3dmodel_xyz_scale[1]
    } ${p.niceview_3dmodel_xyz_scale[2]}))
      (rotate (xyz ${p.niceview_3dmodel_xyz_rotation[0]} ${
      p.niceview_3dmodel_xyz_rotation[1]
    } ${p.niceview_3dmodel_xyz_rotation[2]}))
    )
    `;

    const pin_socket_3dmodel = `
    (model ${p.pin_socket_3dmodel_filename}
      (offset (xyz ${p.pin_socket_3dmodel_xyz_offset[0]} ${
      p.pin_socket_3dmodel_xyz_offset[1]
    } ${p.pin_socket_3dmodel_xyz_offset[2]}))
      (scale (xyz ${p.pin_socket_3dmodel_xyz_scale[0]} ${
      p.pin_socket_3dmodel_xyz_scale[1]
    } ${p.pin_socket_3dmodel_xyz_scale[2]}))
      (rotate (xyz ${p.pin_socket_3dmodel_xyz_rotation[0]} ${
      p.pin_socket_3dmodel_xyz_rotation[1]
    } ${p.pin_socket_3dmodel_xyz_rotation[2]}))
    )
    `;

    const pin_header_3dmodel = `
    (model ${p.pin_header_3dmodel_filename}
      (offset (xyz ${p.pin_header_3dmodel_xyz_offset[0]} ${
      p.pin_header_3dmodel_xyz_offset[1]
    } ${p.pin_header_3dmodel_xyz_offset[2]}))
      (scale (xyz ${p.pin_header_3dmodel_xyz_scale[0]} ${
      p.pin_header_3dmodel_xyz_scale[1]
    } ${p.pin_header_3dmodel_xyz_scale[2]}))
      (rotate (xyz ${p.pin_header_3dmodel_xyz_rotation[0]} ${
      p.pin_header_3dmodel_xyz_rotation[1]
    } ${p.pin_header_3dmodel_xyz_rotation[2]}))
    )
    `;
    ...
    (pad "1" thru_hole oval (at -5.08 16.7 ${
      270 + p.r
    }) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[0].str})
    (pad "2" thru_hole oval (at -2.54 16.7 ${
      270 + p.r
    }) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[1].str})
    (pad "3" thru_hole oval (at 0 16.7 ${
      270 + p.r
    }) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[2].str})
    (pad "4" thru_hole oval (at 2.54 16.7 ${
      270 + p.r
    }) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[3].str})
    (pad "5" thru_hole circle (at 5.08 16.7 ${
      270 + p.r
    }) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") ${socket_nets[4].str})
    ...
    const traces_bottom = `
  (segment (start ${p.eaxy(-5.08, 16.7)}) (end ${
      p.eaxy(-5.08, 18.45)
    }) (width ${p.signal_trace_width}) (layer "F.Cu") (net ${
      socket_nets[0].index
    }))
  (segment (start ${p.eaxy(-2.54, 16.7)}) (end ${
      p.eaxy(-2.54, 18.45)
  ...
  (segment (start ${p.eaxy(2.54, 16.7)}) (end ${
      p.eaxy(2.54, 18.45)
    }) (width ${p.gnd_trace_width}) (layer "B.Cu") (net ${
      socket_nets[3].index
    }))
  (segment (start ${p.eaxy(5.08, 16.7)}) (end ${
      p.eaxy(5.08, 18.45)
